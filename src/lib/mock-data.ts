...
export const mockAds: Ad[] = [
  { id: 'a1', campaignId: '1', campaignName: 'Brand Awareness Q1', clientId: '1', clientName: 'TechFlow', projectId: 'p1', name: 'Hero Video 30s', platform: 'Meta', status: 'Active', spend: 5200, impressions: 220000, clicks: 3600, leads: 82, conversions: 45, mediaType: 'video' },
  { id: 'a2', campaignId: '1', campaignName: 'Brand Awareness Q1', clientId: '1', clientName: 'TechFlow', projectId: 'p1', name: 'Carousel Products', platform: 'Meta', status: 'Active', spend: 4100, impressions: 180000, clicks: 2900, leads: 58, conversions: 30, mediaType: 'image' },
  { id: 'a3', campaignId: '1', campaignName: 'Brand Awareness Q1', clientId: '1', clientName: 'TechFlow', projectId: 'p1', name: 'Story Ad - CTA', platform: 'Meta', status: 'Paused', spend: 3200, impressions: 120000, clicks: 1900, leads: 40, conversions: 20, mediaType: 'video' },
  { id: 'a4', campaignId: '2', campaignName: 'Google Search SaaS', clientId: '1', clientName: 'TechFlow', projectId: 'p1', name: 'RSA - Main Keywords', platform: 'Google', status: 'Active', spend: 8500, impressions: 195000, clicks: 7800, leads: 150, conversions: 100, mediaType: 'image' },
  { id: 'a5', campaignId: '2', campaignName: 'Google Search SaaS', clientId: '1', clientName: 'TechFlow', projectId: 'p1', name: 'RSA - Brand Terms', platform: 'Google', status: 'Active', spend: 5500, impressions: 115000, clicks: 4700, leads: 90, conversions: 60, mediaType: 'image' },
  { id: 'a6', campaignId: '6', campaignName: 'App Install TikTok', clientId: '3', clientName: 'UrbanFit', projectId: 'p4', name: 'Gym Motivation Reel', platform: 'TikTok', status: 'Active', spend: 5400, impressions: 680000, clicks: 19000, leads: 52, conversions: 35, mediaType: 'video' },
  { id: 'a7', campaignId: '6', campaignName: 'App Install TikTok', clientId: '3', clientName: 'UrbanFit', projectId: 'p4', name: 'Before/After UGC', platform: 'TikTok', status: 'Active', spend: 4400, impressions: 520000, clicks: 15000, leads: 43, conversions: 30, mediaType: 'video' },
  { id: 'a8', campaignId: '8', campaignName: 'LinkedIn B2B Leads', clientId: '5', clientName: 'DataPulse', projectId: 'p5', name: 'Whitepaper Lead Gen', platform: 'LinkedIn', status: 'Active', spend: 12000, impressions: 82000, clicks: 3200, leads: 180, conversions: 120, mediaType: 'image' },
  { id: 'a9', campaignId: '8', campaignName: 'LinkedIn B2B Leads', clientId: '5', clientName: 'DataPulse', projectId: 'p5', name: 'Case Study Carousel', platform: 'LinkedIn', status: 'Active', spend: 9000, impressions: 63000, clicks: 2600, leads: 130, conversions: 90, mediaType: 'image' },
];
